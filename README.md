...
### Goal
The goal is to draft a Contact Inventroy Report based on the [Registry Report Structure] and will be delivered through the [Registry Reporting Repository]. It shall be submitted to the IETF as best practice and hopefully result in a [RFC].
